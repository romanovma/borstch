      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_LEFT, handleClick: this.handleClick}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_LEFT, handleClick: this.handleClick}), " ")
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement(WolfImage, {pose: this.state.pose})
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_RIGHT, handleClick: this.handleClick}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_RIGHT, handleClick: this.handleClick}), " ")
          )
        )
      )
    );
