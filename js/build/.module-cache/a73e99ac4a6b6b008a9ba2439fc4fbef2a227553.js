    ...
    return (
      React.createElement("div", null, 
        React.createElement("div", {className: "row", style: divHeaderStyle}, 
          ...
          React.createElement("h4", null, "Продуктов для борща: ", this.state.total, " "), " ", React.createElement("h3", null, " Получено по щщам: ", this.state.slaps, " ")
        ), 
...
var Shelve = React.createClass({displayName: "Shelve",
  ...
  render: function() {
    ...
    return (
      React.createElement("canvas", {style: imgStyle, id: this.props.position, onClick: this.handleClick, onTouchStart: this.handleClick})
    )
  }
});
...
var WolfImage = React.createClass({displayName: "WolfImage",
  ...
  render: function() {
    ...
    return (React.createElement("img", {src: src, style: imgStyle, alt: this.props.pose, onClick: this.handleClick, onTouchStart: this.handleClick}));
  }
});
