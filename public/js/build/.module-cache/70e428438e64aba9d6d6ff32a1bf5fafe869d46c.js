...
var GameBox = React.createClass({displayName: "GameBox",
  ...
  handleClick: function(e) {
    ...
    this.setState({pose: $(e).attr('position')});
    alert($(e).attr('position'));
  },
  render: function() {
    var divStyle = {
      height: '200px'
      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_LEFT, handleClick: this.handleClick(this)}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_LEFT, handleClick: this.handleClick(this)}), " ")
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement(WolfImage, {pose: this.state.pose})
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_RIGHT, handleClick: this.handleClick(this)}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_RIGHT, handleClick: this.handleClick(this)}), " ")
          )
        )
      )
    );
...
var Shelve = React.createClass({displayName: "Shelve",
  ...
  render: function() {
    ...
    switch (this.props.position) {
      case UP_RIGHT:
        return (React.createElement("img", {src: "./images/UP_RIGHT_LINE.jpg", style: imgStyle, onClick: this.props.handleClick}))
        break
      case DOWN_RIGHT:
        return (React.createElement("img", {src: "./images/DOWN_RIGHT_LINE.jpg", style: imgStyle, onClick: this.props.handleClick}))
        break
      case DOWN_LEFT:
        return (React.createElement("img", {src: "./images/DOWN_LEFT_LINE.jpg", style: imgStyle, onClick: this.props.handleClick}))
        break
      case UP_LEFT:
      default:
      return (React.createElement("img", {src: "./images/UP_LEFT_LINE.jpg", style: imgStyle, onClick: this.props.handleClick}))
    }
  }
});
