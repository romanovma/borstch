      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_LEFT}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_LEFT}), " ")
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement(WolfImage, null)
          ), 
          React.createElement("div", {className: "col-lg-4 col-md-4 col-sm-4 col-xs-4"}, 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: UP_RIGHT}), " "), 
            React.createElement("div", null, " ", React.createElement(Shelve, {position: DOWN_RIGHT}), " ")
          )
        )
      )
    );
...
var WolfImage = React.createClass({displayName: "WolfImage",
  ...
  handleClick: function(e) {
      ...
      var verPos = e.pageY - imgPos.top - e.currentTarget.height*10/17;
      //alert(e.pageX);
      //alert(imgPos.left);
