...
var Shelve = React.createClass({displayName: "Shelve",
  ...
  render: function() {
    ...
    var curPosition = this.props.position;
    switch (this.props.position) {
      case UP_RIGHT:
        return (React.createElement("img", {src: "./images/UP_RIGHT_LINE.jpg", style: imgStyle, onClick: this.handleClick(curPosition)}))
        break
      case DOWN_RIGHT:
        return (React.createElement("img", {src: "./images/DOWN_RIGHT_LINE.jpg", style: imgStyle, onClick: this.handleClick(curPosition)}))
        break
      case DOWN_LEFT:
        return (React.createElement("img", {src: "./images/DOWN_LEFT_LINE.jpg", style: imgStyle, onClick: this.handleClick(curPosition)}))
        break
      case UP_LEFT:
      default:
        return (React.createElement("img", {src: "./images/UP_LEFT_LINE.jpg", style: imgStyle, onClick: this.handleClick(curPosition)}))
    }
  }
});
