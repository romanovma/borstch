...
var GameBox = React.createClass({displayName: "GameBox",
  ...
  handleClick: function(curPosition) {
    //var position = $(e.currentTarget).attr('position');
    //this.setState({pose: curPosition});
    alert(toString(curPosition));
  },
  render: function() {
    var divStyle = {
      height: '200px'
...
var Shelve = React.createClass({displayName: "Shelve",
  ...
  handleClick: function(curPosition) {
    this.props.onClick.bind(this, curPosition);
    //alert(curPosition);
  },
  render: function() {
    var imgStyle = {
    ...
    return (React.createElement("img", {src: src, style: imgStyle, onClick: this.handleClick.bind(this, curPosition)}))
  }
});
